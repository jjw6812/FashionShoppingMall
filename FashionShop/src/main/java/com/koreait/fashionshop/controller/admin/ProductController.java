...
public class ProductController implements ServletContextAware{
	...
	/*
	@RequestMapping(value="/admin/product/sublist", method=RequestMethod.GET, produces = "application/json;charset=utf-8")
	@ResponseBody //jsp와 같은 뷰페이지가 아닌, 단순 데이터만 전송시...
	public String getSubList(int topcategory_id) {
		logger.debug(""+topcategory_id);
